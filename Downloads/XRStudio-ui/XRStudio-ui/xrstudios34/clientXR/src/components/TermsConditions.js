    ...
    <div>
      ...
      <div className="privacy-policy">
        ...
        <section id="privacy-protection">
          <h3>PURHCASE OF PRODUCTS</h3>
          <p>
            The delivery of the products is solely dependent on the availability
            at the time of purchase. The variation in product is acceptable with
            or without notice.
          </p>
        </section>
        <section id="privacy-cookies">
          ...
          <p>
            ...
            associated with the corporate brand is responsible for guarantee on
            placements. We ensure to connect participants with potential
            employers.
          </p>
        </section>
        <section id="privacy-disclose-third-party">
          ...
          <p>
            ...
            security may result in civil or criminal liability. The business and
            / or its associate entities will have the right to investigate
        ...
        <section id="privacy-third-party-links">
          ...
          <p>
            ...
            resulting from their use of www.machenn.com or their breach of the
            terms .{" "}
          </p>
        </section>
